#!/bin/bash
# ============================================================================
# DQN + RND — Full Sweep (CPU)
# Student A (Mohammad)
#
# Usage:
#   bash scripts/run_dqn_rnd_sweep_cpu.sh
#   bash scripts/run_dqn_rnd_sweep_cpu.sh --parallel 2
#   bash scripts/run_dqn_rnd_sweep_cpu.sh --parallel 4
# ============================================================================
